...
namespace DynData
{
    public class Global : System.Web.HttpApplication
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            model.RegisterContext(typeof(NWindDataContext), new ContextConfiguration() { ScaffoldAllTables = true });

           //model.RegisterContext(typeof(PubsDataContext), new ContextConfiguration() { ScaffoldAllTables = true });

            //model.RegisterContext(typeof(DynData.WebData.AWorksDataContext), new ContextConfiguration() { ScaffoldAllTables = true });
