...
namespace DynData
{
    ...
    partial void OnpubdateChanged();
		...
		[Column(Name="title", Storage="_title1", DbType="VarChar(80) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="title_sale", Storage="_sales", ThisKey="title_id", OtherKey="title_id")]
		...
		[Association(Name="title_titleauthor", Storage="_titleauthors", ThisKey="title_id", OtherKey="title_id")]
		public EntitySet<titleauthor> titleauthors
		{
			get
			{
		...
		[Association(Name="publisher_title", Storage="_publisher", ThisKey="pub_id", OtherKey="pub_id", IsForeignKey=true)]
    ...
    partial void Onhire_dateChanged();
		...
		[Column(Storage="_emp_id", DbType="Char(9) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_fname", DbType="VarChar(20) NOT NULL", CanBeNull=false)]
		public string fname
		{
			get
			{
		...
		[Column(Storage="_lname", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		public string lname
		{
			get
			{
		...
		[Column(Storage="_job_id", DbType="SmallInt NOT NULL")]
		public short job_id
		{
			get
			{
		...
		[Column(Storage="_job_lvl", DbType="TinyInt")]
		...
		[Column(Storage="_pub_id", DbType="Char(4) NOT NULL", CanBeNull=false)]
		public string pub_id
		{
			get
			{
		...
		[Column(Storage="_hire_date", DbType="DateTime NOT NULL")]
		...
		[Association(Name="job_employee", Storage="_job", ThisKey="job_id", OtherKey="job_id", IsForeignKey=true)]
		public job job
		{
			get
			{
		...
		[Association(Name="publisher_employee", Storage="_publisher", ThisKey="pub_id", OtherKey="pub_id", IsForeignKey=true)]
		public publisher publisher
		{
			get
			{
    ...
    partial void Onmax_lvlChanged();
		...
		[Column(Storage="_job_id", AutoSync=AutoSync.OnInsert, DbType="SmallInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public short job_id
		{
			get
			{
		...
		[Column(Storage="_job_desc", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_min_lvl", DbType="TinyInt NOT NULL")]
		public byte min_lvl
		{
			get
			{
		...
		[Column(Storage="_max_lvl", DbType="TinyInt NOT NULL")]
		public byte max_lvl
		{
			get
			{
		...
		[Association(Name="job_employee", Storage="_employees", ThisKey="job_id", OtherKey="job_id")]
    ...
    partial void Onpr_infoChanged();
		...
		[Column(Storage="_pub_id", DbType="Char(4) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string pub_id
		{
			get
			{
		...
		[Column(Storage="_pr_info", DbType="Text", UpdateCheck=UpdateCheck.Never)]
		...
		[Association(Name="publisher_pub_info", Storage="_publisher", ThisKey="pub_id", OtherKey="pub_id", IsForeignKey=true)]
		public publisher publisher
		{
			get
			{
    ...
    partial void OncountryChanged();
		...
		[Column(Storage="_pub_name", DbType="VarChar(40)")]
		...
		[Column(Storage="_country", DbType="VarChar(30)")]
		...
		[Association(Name="publisher_title", Storage="_titles", ThisKey="pub_id", OtherKey="pub_id")]
		...
		[Association(Name="publisher_employee", Storage="_employees", ThisKey="pub_id", OtherKey="pub_id")]
		public EntitySet<employee> employees
		{
			get
			{
		...
		[Association(Name="publisher_pub_info", Storage="_pub_info", ThisKey="pub_id", OtherKey="pub_id", IsUnique=true, IsForeignKey=false)]
	...
	public partial class roysched
	{
		...
		[Column(Storage="_title_id", DbType="VarChar(6) NOT NULL", CanBeNull=false)]
		public string title_id
		{
			get
			{
		...
		[Column(Storage="_lorange", DbType="Int")]
		...
		[Column(Storage="_hirange", DbType="Int")]
    ...
    partial void Ontitle_idChanged();
		...
		[Association(Name="title_sale", Storage="_title", ThisKey="title_id", OtherKey="title_id", IsForeignKey=true)]
		public title title
		{
			get
			{
		...
		[Association(Name="store_sale", Storage="_store", ThisKey="stor_id", OtherKey="stor_id", IsForeignKey=true)]
		public store store
		{
			get
			{
    ...
    partial void OnzipChanged();
		...
		[Association(Name="store_sale", Storage="_sales", ThisKey="stor_id", OtherKey="stor_id")]
		public EntitySet<sale> sales
		{
			get
			{
    ...
    partial void OnroyaltyperChanged();
		...
		[Association(Name="title_titleauthor", Storage="_title", ThisKey="title_id", OtherKey="title_id", IsForeignKey=true)]
		public title title
		{
			get
			{
